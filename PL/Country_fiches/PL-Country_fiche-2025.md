...
o	Równolegle z aktualizacją regulacji prawnych Ministerstwo Rozwoju i Technologii rozwijało serwis internetowy: [https://www.gov.pl/web/zagospodarowanieprzestrzenne](https://www.gov.pl/web/zagospodarowanieprzestrzenne). W 2023 r. w serwisie opublikowano zaktualizowane materiały o charakterze wytycznych technicznych, m.in.:
...
•	Ponadto w 2024 r. na potrzeby danych wysokiej wartości utworzono nową instancję katalogu metadanych - [https://mapy.geoportal.gov.pl/wss/service/HVDcsw/guest](https://mapy.geoportal.gov.pl/wss/service/HVDcsw/guest)** 
...
•	Ponadto, Polska zaangażowała się w kilka wspólnych inicjatyw z krajami sąsiednimi. Np. udostępnianie otwartych paneuropejskich danych przestrzennych w ramach Open European Location Services - [https://openels.eu/](https://openels.eu/).[Wartość dodana UE]. 
...
o	Nowy katalog metadanych, zbiory i usługi danych przestrzennych zostały opublikowane na portalu PIG-PIB INSPRE ([https://www.pgi.gov.pl/inspire](https://www.pgi.gov.pl/inspire)).
...
[https://geo.stat.gov.pl/geonetwork/srv/pol/csw](https://geo.stat.gov.pl/geonetwork/srv/pol/csw)
...
[https://geo.stat.gov.pl/wss/wms_inspire/wms](https://geo.stat.gov.pl/wss/wms_inspire/wms)
...
3.	Usługi pobierania:
•	dla tematu jednostki statystyczne adres usługi to: [https://geo.stat.gov.pl/atom-web/atom/SU](https://geo.stat.gov.pl/atom-web/atom/SU)
•	dla tematu rozmieszczenie ludności (demografia) adres usługi to: [https://geo.stat.gov.pl/atom-web/atom/PD](https://geo.stat.gov.pl/atom-web/atom/PD)
GUS udostępnia w Portalu Geostatystycznym ([https://portal.geo.stat.gov.pl/pl/inspire/](https://portal.geo.stat.gov.pl/pl/inspire/)) aktualne zbiory danych dla dwóch tematów danych przestrzennych:
...
GUS poinformował GUGiK także o zaktualizowaniu metadanych dla obydwu tematów i możliwości federacji z krajowym katalogiem metadanych katalogu metadanych GUS, który dostępny jest pod adresem: [https://geo.stat.gov.pl/geonetwork/srv/pol/csw?SERVICE=CSW&REQUEST=GetCapabilities&VERSION=2.0.2](https://geo.stat.gov.pl/geonetwork/srv/pol/csw?SERVICE=CSW&REQUEST=GetCapabilities&VERSION=2.0.2). Szczegóły dotyczące usług zostały opisane na stronie Portalu Geostatystycznego w zakładce INSPIRE ([https://portal.geo.stat.gov.pl/pl/inspire/](https://portal.geo.stat.gov.pl/pl/inspire/)).
...
GUS udostępnił w Portalu Geostatystycznym ([https://portal.geo.stat.gov.pl/pl/inspire/](https://portal.geo.stat.gov.pl/pl/inspire/)) aktualne zbiory danych dla dwóch tematów danych przestrzennych:
...
o	Budowy pojedynczych punktów dostępu do wielu rozproszonych usług lokalnych [https://github.com/INSPIRE-MIF/gp-single-access-point](https://github.com/INSPIRE-MIF/gp-single-access-point)
o	Usług przeglądania WMS pozwalających na pobieranie danych [https://github.com/INSPIRE-MIF/gp-data-download-wms](https://github.com/INSPIRE-MIF/gp-data-download-wms)
...
•	GGK inicjował również prace naukowe i badawczo-rozwojowe w zakresie zastosowania metod informatycznych w dziedzinie geodezji i kartografii, zapewniając tym samym wysoką jakość danych przestrzennych IIP oraz wykorzystanie najnowszych technologii. M.in. w 2022 r. GGK zgłosił propozycję projektu badawczego do NCBiR w ramach programu INFOSTRATEG pt. „Automatyczna detekcja obiektów topograficznych”, która jako jedyna ze zgłoszonych przez różne instytucje propozycji została wybrana do realizacji [https://www.gov.pl/web/ncbr/v-konkurs-infostrateg-na-projekty-zamawiane](https://www.gov.pl/web/ncbr/v-konkurs-infostrateg-na-projekty-zamawiane)
